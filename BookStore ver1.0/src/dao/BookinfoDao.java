...
public class BookinfoDao {
	...
	public String getBookNameById(int bid){
		Bookinfo book = findBookById(String.valueOf(bid));
		if (book == null)
			return null;
	...
	public boolean updateBook(Bookinfo book)
	{
		...
		try{
			...
			oldBook.setAbstractInfo(book.getAbstractInfo());
			oldBook.setBookname(book.getBookname());
			oldBook.setBooknum(book.getBooknum());
			oldBook.setCategory(book.getCategory());
			oldBook.setDetail(book.getDetail());
