                    ...
                    <ul class="nav nav-sidebar center">
                    	...
                    	<%
                    		...
                    		for (Iterator<String> it = categoryList.iterator(); it.hasNext();){
                    			...
                    			if (flag == false){
                    	%>
                    				<li id="<%=count%>" class="nav_category active" style="text-align:center;"><a herf="#" ><big><%=(String)it.next() %></big><span class="sr-only">(current)</span></a>
                    	<%
                    				flag = true;
                    			}else{
                    	%>
                    				<li id="<%=count%>" class="nav_category" style="text-align:center;"><a herf="#"><big><%=(String)it.next() %></big><span class="sr-only">(current)</span></a>
                    	<%
                    			}
                    		}
                    	%>
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
      			<div class="modal-header">
        			...
        			<strong>Pick up Book Successfully!</strong>
      			</div>
      			<div>
      				<span></span><br/>
      				<span></span><br/>
