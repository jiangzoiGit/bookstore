            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                    	<li id="1" class="nav_category active"><a herf="#" >My Account<span class="sr-only">(current)</span></a>
      						...
      						<div class="panel panel-default">
      							...
      							<div class="panel-body">
      								<div class="container">
      									...
      									<div class="col-md-4">
      										<img class="img-thumbnail" alt="200x200" src="img/photo/<%=userServ.findPhoto(userid) %>" data-holder-rendered="true">
      										<br/>
      									</div>
      									<div class="col-md-3">
      										&nbsp;<br/>
