            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                    	<li id="1" class="nav_category active" style="text-align:center;"><a herf="#" >Shopping Cart<span class="sr-only">(current)</span></a>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h2 class="title">Shopping cart</h2>
		            	<table class="table">
			                ...
			                <%
			                	...
			                	if (itemList == null){
			                		...
			                		for (Iterator<OrderinfoItem> it = itemList.iterator(); it.hasNext();){
			                			...
			                			item.calcPrice();
			                			Bookinfo book = bookinfoDao.findBookById(String.valueOf(item.getBookid()));
			                %>
			                <!--Item-->
			                <tr class="item first">
			                  <td class="thumb"><img onclick="displayDetail(<%=book.getId() %>)" src="img/<%=book.getImage() %>" alt="Picture" class="img-rounded" onerror="this.src='book-default.jpg'"></td>
			                  <td class="bookname" style="vertical-align: middle;"><%=book.getBookname() %></td>
		              	...
		              	<s:form role="form" action="Pay" style="float:right">
	...
	<div class="modal fade" id="updateForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        				...
        				<tbody>
        					...
        					<tr>
				                ...
				                <td class="qnt-count" style="vertical-align: middle;">
				                    ...
				                    <input id="updateFormBookNum" class="quantity" type="text" value="0"/ readonly>
				                    <a class="incr-btn" href="#">+</a>
				                </td>
		...
		<script>
			...
			$(".modifyItem").on("click", function(e){
				var $button = $(this);
				var bookName = $button.parent().parent().find("td").eq(1).text();
				var price = $button.parent().parent().find("td").eq(2).find("span").text();
				var booknum = $button.parent().parent().find("td").eq(3).text();
				var total = $button.parent().parent().find("td").eq(4).find("span").text();
