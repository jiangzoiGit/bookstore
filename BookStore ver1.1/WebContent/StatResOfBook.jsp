...
<body>
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
                ...
                <div class="row-fluid section">
                    <h4 class="title">Book Sells By Time</h4>
    ...
    <script type="text/javascript">
        ...
        Morris.Bar({
	        ...
	        {
				double sells = data.get(bookname).doubleValue();
            %>
                {bookname: '<%=bookname %>', sells: <%=df.format(sells) %>},
           	<%
	        }
            }
            %>
        ...
        Morris.Donut({
            ...
            for(String bookname : data.keySet())
	        {
				double sells = data.get(bookname).doubleValue();
            %>
                {label: '<%=bookname%>', value: <%=df.format(sells)%> },
            <%
	        }
            }
            %>
